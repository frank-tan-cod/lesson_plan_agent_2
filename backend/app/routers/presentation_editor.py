"""HTTP routes for the presentation editor chat endpoint."""
...
from ..dependencies import (
    ...
    get_plan_service,
    get_presentation_tools_registry,
    get_session_factory,
)
from ..schemas import EditorChatRequest
from ..services import ConversationService, OperationService, PlanService, PresentationEditor
from ...tools import ToolExecutor, ToolsRegistry

router = APIRouter(prefix="/api/presentation", tags=["presentation-editor"], dependencies=[Depends(get_current_user_id)])
...
async def chat(
    ...
    """Stream presentation editor responses as server-sent events."""
    ...
    tools_registry: ToolsRegistry = get_presentation_tools_registry()
